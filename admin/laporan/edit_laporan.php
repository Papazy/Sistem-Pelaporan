                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                while ($jenis = mysqli_fetch_array($query_jenis)) { ?>
									<option value="<?= $jenis['satuan'] ?>" <?= $jenis['satuan']==$data_laporan['satuan'] ? ' selected' : '' ?>><?= ucwords($jenis['judul_satuan']) ?></option>
                                <?php
                                };
                                ?>
								</select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                while ($jenis = mysqli_fetch_array($query_jenis)) { ?>
									<option value="<?= $jenis['kegiatan'] ?>" <?= $jenis['kegiatan']==$data_laporan['kegiatan'] ? ' selected' : '' ?>><?= ucwords($jenis['judul_kegiatan']) ?></option>
                                <?php
                                };
                                ?>
								</select>
