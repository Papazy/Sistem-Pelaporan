                ...
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                    <div class="col mx-auto">
                        <div class="mb-4 text-center">
                            <img src="assets/images/bidtik.png" width="120" height="120" alt="" />
                        </div>
                        <?php
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    <div class="form-body">
                                        <br><center><p>Selamat Datang </p></center>

                                        <form class="row g-3" method="POST" action="" enctype="multipart/form-data">
                                            <div class="col-12">
                                                <label for="inputEmailAddress" class="form-label">Masukan NRP</label>
                                                <input type="text" name="NRP" class="form-control" id="inputEmailAddress" value="" placeholder="No. NRP">
                                            </div>
                                            <div class="col-12">
